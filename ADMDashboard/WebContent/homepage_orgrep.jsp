			...
			<div class="row">
				<div class="col s7">
					<div class="col s12">
						...
						<a class="waves-effect waves-light btn" href="CSO1617ActivityReport.doc"
							download="CSO1617 Activity Report"> <i
							class="material-icons left">get_app</i>Download Post-Acts Form
						</a> <br> <br>
						
						<a class="waves-effect waves-light btn" href="CSO1617GALS.doc"
							download="CSO1617 GALS"> <i
							class="material-icons left">get_app</i>Download General Attendance Log Sheet
						</a>
