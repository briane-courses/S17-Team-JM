...
<body>
  ...
  function signOut() {
	...
	<ul id="slide-out" class="side-nav fixed">
		...
		<li><a href="#" class="home2">
			<i class="material-icons left">today</i>Calendar of special deadlines</a></li>
		<li class="active"><a href="#" class="home3">
			<i class="material-icons">view_list</i>List of Organizations</a></li>
		<li><a href="#modal2" id="modal-trigger1">
			<i class="material-icons">settings</i>Sign Out</a></li>
	</ul>
	...
	<div class="row">
		...
		<div class="col s9">
			...
			<label id="noOrgFound">${noOrgFound }</label>
